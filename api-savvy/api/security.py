...
REFRESH_TOKEN_SECRET = (
    "0fab5a909fd8c7d652edd6f7e15635f64bf1d00e354069052641c5549a91df1b"
)
...
def _create_token(
    user_id, type: Literal["access", "refresh"], secret: str, expire: datetime
) -> str:
    ...
    try:
        ...
        if payload.get("type") != type:
            raise HTTPException(
                ...
                detail=f"Invalid {type} token type: {payload.get('type')}",
            )
        return payload
